...
float modelColor[4] = { 1.0, 0.5, 0.31, 1.0 };
...
void callATB(TwBar *bar, GLFWwindow *window) {
	...
	TwAddVarRW(bar, "ptAmbientLightColor", TW_TYPE_COLOR3F, &ptAmbientLightColor, " label='Pt Ambient Light color' ");
	...
	TwAddButton(bar, "resetPtLight", (TwButtonCallback)DefLight, NULL, " label='Reset Point Light' ");
